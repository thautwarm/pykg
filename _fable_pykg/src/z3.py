...
def solve(a: List[AstRef[bool]]) -> Optional[z3Model]:
    def arrow_17(m: ModelRef, a: List[AstRef[bool]]=a) -> z3Model:
        return z3model__ctor_D649C1C(m)
    
    return map(arrow_17, solve_deps(a))
...
def test() -> None:
    ...
    def arrow_19(__unit: Any=None) -> AstRef[bool]:
        ...
        arg1_2 = v == arg1_4
        def arrow_18(__unit: Any=None) -> AstRef[bool]:
            arg1_3 : AstRef[Tuple[int, int, int]] = const_ver(1, 2, 6)
            return v == arg1_3
        
        return Or(arrow_18(), arg1_2)
    
    model : Optional[z3Model] = solve([ge_tuple(v, const_ver(1, 2, 3)), le_tuple(v, const_ver(1, 2, 8)), arrow_19()])
    if model is not None:
        model_1 : z3Model = model
        tupled_arg : Tuple[int, int, int]
        x : AstRef[Tuple[int, int, int]] = model_1.m[v]
        def arrow_20(__unit: Any=None) -> int:
        ...
        tupled_arg = (arrow_20(), arrow_21(), arrow_22())
