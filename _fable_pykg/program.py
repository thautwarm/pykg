...
def test_load_proj(comfig_string: str) -> None:
    ...
    arg10 : str = show_doc(default_render_options, serialize_comp(arrow_15(obj_from_comp(project_reflection(), parse(comfig_string)))))
    to_console(printf("%s"))(arg10)


def test_load_meta(comfig_string: str) -> None:
    def arrow_16(o: Any=None, comfig_string: str=comfig_string) -> Component:
        return obj_to_comp(metadata_reflection(), o)
    
    arg10 : str = show_doc(default_render_options, serialize_comp(arrow_16(obj_from_comp(metadata_reflection(), parse(comfig_string)))))
    to_console(printf("%s"))(arg10)
